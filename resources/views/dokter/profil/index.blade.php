              ...
              <form action="{{ url('profil/'.$datas->id_dokter) }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="_method" value="PATCH">
                    <div class="form-group">
                      ...
                      <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ $datas->nama }}" required>
                      @error('nama')
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('no_hp') is-invalid @enderror" name="no_hp" value="{{ $datas->no_hp }}">
                      @error('no_hp')
                      <span class="invalid-feedback role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
